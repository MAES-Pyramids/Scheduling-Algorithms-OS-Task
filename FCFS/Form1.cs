...
namespace FCFS
{
    public partial class Form1 : Form
    {
        ...
        {
            checkedListBox1.Items.Add(process1.Text);
            checkedListBox1.Items.Add(process2.Text);
            checkedListBox1.Items.Add(process3.Text);
            checkedListBox1.Items.Add(process4.Text);
